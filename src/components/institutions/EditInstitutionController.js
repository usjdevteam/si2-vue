...
methods : {
    ...
    async updateInstitution() {
      ...
      this.institution.address.latitude = (this.institution.address.latitude == 0 ? '0.0000000' :  this.institution.address.latitude);
      this.institution.address.longitude = (this.institution.address.longitude == 0 ? '0.0000000' :  this.institution.address.longitude);
